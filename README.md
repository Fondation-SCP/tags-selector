...
– `src/get.js` : méthodes interagissant avec l'ontologie via des requêtes SPARQL  
– `src/init.js` : chargement des données globales  
– `src/main.js` : point de départ de l'application (initialisation + lancement)  
